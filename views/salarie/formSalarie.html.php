...
<?php $formation = $template->formation ?>
    ...
    <div class="d-flex justify-content-center ml-auto">
        <form action="" method="post" class="text-center">
            ...
            <div class="form-row">
                <div class="form-group <?= $formErrors != null ? $formErrors['nom'] : '' ?>">
                    <label for="nom">Nom *</label>
                    <input type="text" class="form-control" id="nom" name="salarie_form[nom]"
                        value="<?= $formSalarie != null ? $formSalarie['nom'] : '' ?>">
                </div> 
                <div class="form-group <?= $formErrors != null ? $formErrors['prenom'] : '' ?>">
            ...
            <div class="form-row">
                <div class="form-group <?= $formErrors != null ? $formErrors['date_naissance'] : '' ?>">
                ...
                <div class="form-group <?= $formErrors != null ? $formErrors['lieu_naissance'] : '' ?>">
            ...
            <div class="form-row"> 
                <div class="form-group  <?= $formErrors != null ? $formErrors['code_postal'] : '' ?>">
                ...
                <div class="form-group <?= $formErrors != null ? $formErrors['ville'] : '' ?>">
            ...
            <div class="form-row">
                <div class="form-group <?= $formErrors != null ? $formErrors['mail_professionnel'] : '' ?>">
                ...
                <div class="form-group <?= $formErrors != null ? $formErrors['mail_personnel'] : '' ?>">
