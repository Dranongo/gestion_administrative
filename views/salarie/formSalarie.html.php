...
<?php $formation = $template->formation ?>
        ...
        <form action="" method="post" class="col-md-8 offset-md-2">
            ...
            <div class="form-row"> 
                <div class="form-group col-md-6<?= $formErrors != null ? $formErrors['code_postal'] : '' ?>">
                ...
                <div class="form-group col-md-6<?= $formErrors != null ? $formErrors['ville'] : '' ?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-6<?= $formErrors != null ? $formErrors['telephone'] : '' ?>">
                ...
                <div class="form-group col-md-6<?= $formErrors != null ? $formErrors['numero_securite_sociale'] : '' ?>">
