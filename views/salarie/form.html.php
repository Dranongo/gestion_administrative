...
<?php $salarie = $template->salarie ?>
    ...
    <form action="" method="post">
        ...
        <div class="form-row col-md">
            <div class="form-group col-md-4<?= $formErrors != null ? $formErrors['nom'] : '' ?>">
                <label for="nom">Nom *</label>
                <input type="text" class="form-control" id="nom" name="salarie_form[nom]"
                    value="<?= $form != null ? $form['nom'] : '' ?>">
            </div> 
            <div class="form-group col-md-4<?= $formErrors != null ? $formErrors['prenom'] : '' ?>">
        ...
        <div class="form-row col-md">
            <div class="form-group col-md-3 <?= $formErrors != null ? $formErrors['date_naissance'] : '' ?>">
            ...
            <div class="form-group col-md-4 <?= $formErrors != null ? $formErrors['lieu_naissance'] : '' ?>">
        ...
        <div class="form-row col-md"> 
            ...
            <div class="form-group col-md-3 <?= $formErrors != null ? $formErrors['ville'] : '' ?>">
        ...
        <div class="form-row col-md">
            <div class="form-group col-md-4 <?= $formErrors != null ? $formErrors['mail_professionnel'] : '' ?>">
            ...
            <div class="form-group col-md-4 <?= $formErrors != null ? $formErrors['mail_personnel'] : '' ?>">
        ...
        <div class="form-group col-md-5<?= $formErrors != null ? $formErrors['numero_securite_sociale'] : '' ?>">
        ...
        <div class="form-group col-md-5 <?= $formErrors != null ? $formErrors['situation_familiale'] : '' ?>">
        ...
        <div class="form-group col-md-7 <?= $formErrors != null ? $formErrors['details_autre_activite'] : '' ?>">
        ...
        <div class="form-group col-md-7 <?= $formErrors != null ? $formErrors['statut_handicap'] : '' ?>">
        ...
        <div class="form-group col-md <?= $formErrors != null ? $formErrors['taux_invalidite'] : '' ?>">
        ...
        <div class="form-group col-md-7 <?= $formErrors != null ? $formErrors['taux_invalidite'] : '' ?>">
            <label for="taux_invalidite">Détails taux invalidité *</label>
            <input type="text" class="form-control" id="taux_invalidite" name="salarie_form[taux_invalidite]"
                   value="<?= $form != null ? $form['taux_invalidite'] : '' ?>">
        </div>
